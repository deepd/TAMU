...
REFERENCE = Image.open('rsz_monalisa.jpg')
...
class Strain(object):
	...
	def draw(self):
		...
		for poly in self.dna:
			draw.polygon(poly['ellipse'], aggdraw.Brush(poly['color']))
		draw.flush()
...
def generate_ellipse():
	...
	return [x - width, y - width, x, y , x + width, y + width, x1, y1]
...
def generate_color(prev = None):
	...
	#return (255, 255, 255, random.randint(0, 0xff))
